...
export class TestcomponentComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.usersObj = new User("GOOGLE", "111330112265722171611", "ishan.dua01@gmail.com", "ISHAN DUA",
    "https://lh3.googleusercontent.com/a-/AOh14Ghw3-K1xXMkvsWEUP_Yc8JNwPHzRWsI732q-4-BjpM=s96-c");
  }
  getData(){
